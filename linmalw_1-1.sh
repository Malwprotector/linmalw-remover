...
echo "done"
echo "--------------------------------------"
echo "----welcome to linmalw remover 1.1----"
echo "--------------------------------------"
echo ""
...
echo ""
echo "Also make sure that this script is placed in the main folder of your user account: it doesn't matter if it isn't, but some commands might not return a good result."
echo ""
...
echo ""
echo "Here are all the files created in the last 2 hours. Check if anything is wrong."
echo ""
read -n 1 -s -r -p "Press any key to continue..."
echo ""
echo ""
...
echo ""
echo "Made with <3 by St4lW | https://main.st4lwolf.org"
